          ...
          <div className={styles.tripMenus}>
            ...
            <button className={styles.hotel}>
              <div className={styles.attractionsIcon}>
                ...
                <img className={styles.trainIcon} alt="" src="/train@2x.png" />
              </div>
            ...
            <button className={styles.hotel}>
              <div className={styles.taxiIcon}>
                ...
                <img className={styles.taxiIcon1} alt="" src="/taxi@2x.png" />
              </div>
            ...
            <button className={styles.hotel}>
              <div className={styles.attractionsIcon}>
                ...
                <img className={styles.movieIcon} alt="" src="/movie@2x.png" />
              </div>
